...
<center>
<a href="<?=site_url("provider/decorationlist")?>">
<img src="<?=base_url("img/cake.png")?>">
</a>&nbsp;&nbsp;&nbsp;
    <a href="<?=site_url("provider/giftlist")?>"><img src="<?=base_url("img/gift1.png")?>"></a>
	
	<table width="50%" style="text-align:center;"><tr><td><h1>Decoration</h1></td><td><h1>Gift</h1></td></tr></table>
       </div>
